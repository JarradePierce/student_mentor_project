...
@mentor1 = Mentor.create(username: "Joshuah", email: "123@123.com", password: "123", phase: 1)
@mentor2 = Mentor.create(username: "Erika", email: "123@123.com", password: "123", phase: 1)
